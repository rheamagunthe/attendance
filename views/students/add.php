				...
				<div class="box-group" id="accordion">
		                ...
		                <div id="collapseOne" class="panel-collapse collapse in">
		                	...
		                	<div class="box-body">
								...
								<div class="form-group">
									...
									<button type="button" class="btn btn-block btn-primary" id="btnCapture"><i class="fa fa-camera"></i> Capture Image</button>
								</div>
								<div class="form-group">
							...
							<div class="box-footer text-right">
								<a class="btn btn-" href="<?php echo URL; ?>students">Cancel</a>
					...
					<div class="panel box box-warning">
		                ...
		                <div id="collapseTwo" class="panel-collapse collapse">
							...
							<div class="box-footer text-right">
								<a class="btn btn-primary" href="<?php echo URL; ?>students">Cancel</a>
								<button class="btn btn-primary">Submit</button>
							</div>
							</form>
			            </div>

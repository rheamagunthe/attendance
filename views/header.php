...
<body class="hold-transition <?php echo (Session::get('loggedIn')) ? "skin-green sidebar-mini": "login-page"; ?><?php echo isset($this->bodyClass) ? $this->bodyClass : ""; ?>"><?php echo "\n"; ?>
<div class="wrapper" style="background-image: url(public/ssaocover.jpg);">
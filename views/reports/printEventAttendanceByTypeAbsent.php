...
<table style="width: 100%; margin-bottom: 20px;">
	<tbody>
		<tr>
			<td class="text-right" style="width: 10%"><img style="width: 100px" src="<?php echo URL; ?>public/ssaologo.jpg" /></td>
			<td style="width: 80%">
			<h2 class="text-center text-bold">Kabankalan Catholic College Inc.</h2>
			<h3 class="text-center text-bold">Supreme Students Affairs Organization</h3>

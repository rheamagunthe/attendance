...
$totalAbsent = 0;
?> -->
<!-- <p class="text-center"><img style="width: 150px" src="<?php echo URL; ?>public/ssaologo.jpg" /></p>
<h3 class="text-bold text-center">SSAO Student Attendance Profile</h3>
